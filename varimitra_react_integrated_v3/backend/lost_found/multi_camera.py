...
p=argparse.ArgumentParser(); p.add_argument('--config',default='cameras.json'); p.add_argument('--gpu',action='store_true'); p.add_argument('--display',action='store_true'); a=p.parse_args()
