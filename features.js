...
(function(){
  ...
  function currentPage(){
    ...
    return p || "varimitra.html";
  }

  function goToFeature(key){
    var back = currentPage();
    location.href = "feature.html?key=" + encodeURIComponent(key) + "&back=" + encodeURIComponent(back);
  }
    ...
    wrap.innerHTML =
      '<div class="vm-modal-overlay" id="vmModalOverlay">' +
        '<div class="vm-modal" role="dialog" aria-modal="true" aria-labelledby="vmModalTitle">' +
          ...
          '<div class="vm-modal-foot"><button id="vmModalOk">Got it</button></div>' +
        '</div>' +
      '</div>';
