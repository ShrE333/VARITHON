...
export default function VariMitraPage() {
  ...
  // Admins get bounced to their own dashboard; anyone not signed in at all
  ...
  useEffect(() => {
    ...
    try {
      if (JSON.parse(saved).role === 'admin') router.replace('/command-dashboard');
    } catch {
      router.replace('/');
    }
  }, [router]);
...
<header className="topbar">
  ...
  <div className="topbar-right">
    ...
    <div className="bell" data-modal data-feature="notifications" tabIndex="0"><i className="fa-regular fa-bell"></i><span className="dot">9+</span></div>
    ...
    <a href="/" onClick={handleLogout}  data-i18n-title="common.signOutTitle" title="Sign Out / Switch Role" style={{"color":"var(--maroon)","fontSize":"15px","padding":"6px 10px","borderRadius":"8px","background":"var(--cream)","border":"1px solid var(--card-border)","display":"flex","alignItems":"center","gap":"6px","fontWeight":"600"}}><i className="fa-solid fa-arrow-right-from-bracket"></i> <span style={{"fontSize":"12px"}} data-i18n="common.signOut">Sign Out</span></a>
  </div>
</header>
...
<div className="layout">
  ...
  <aside className={navOpen ? 'sidebar open' : 'sidebar'} id="sidebar">
    ...
    <a className="side-link" data-modal data-feature="live-darshan" tabIndex="0"><span className="l"><i className="icn fa-solid fa-video"></i><span data-i18n="pilgrim.sidebarLiveDarshan">Live Darshan</span></span><i className="chev fa-solid fa-chevron-right"></i></a>
  ...
  <main className="content">
    ...
    <section className="hero">
      <div className="hero-slider">
        <div className="hero-track" id="heroTrack">
          <div className="hero-slide" style={{"backgroundImage":"url('assets/img/wari-1.png')"}}></div>
          <div className="hero-slide" style={{"backgroundImage":"url('assets/img/wari-2.png')"}}></div>
          <div className="hero-slide" style={{"backgroundImage":"url('assets/img/wari-3.png')"}}></div>
        </div>
      </div>
      <div className="hero-dots" id="heroDots">
        <span className="active" data-i="0" aria-label="Slide 1"></span>
        <span data-i="1" aria-label="Slide 2"></span>
        <span data-i="2" aria-label="Slide 3"></span>
      </div>
      <div className="hero-inner">
        <h1>VariMitra</h1>
        <h2 data-i18n-html="pilgrim.heroSubtitle">Your Pilgrim Companion for<br />Pandharpur Wari (Vari)</h2>
        <p className="sub" data-i18n="pilgrim.heroTagline">Seva, Suraksha, Sanskriti — All in One Platform</p>
        <div className="hero-badges">
          <div className="b" data-modal data-feature="crowd-safety" tabIndex="0"><i className="fa-solid fa-microchip"></i>AI-Powered<br />Smart Assistance</div>
          <div className="b" data-modal data-feature="notifications" tabIndex="0"><i className="fa-solid fa-signal"></i>Real-time<br />Crowd & Alerts</div>
          <div className="b" data-modal data-feature="multilingual" tabIndex="0"><i className="fa-solid fa-language"></i>Multilingual<br />All Pilgrims Welcome</div>
          <div className="b" data-modal data-title="Secure & Trusted" data-icon="fa-solid fa-shield-halved" data-color="#1F9D55" data-tag="Enterprise-Grade Security" data-body="Every service on VariMitra runs on enterprise-grade security — your data and identity stay protected, always." tabIndex="0"><i className="fa-solid fa-shield-halved"></i>Secure & Trusted<br />By Devotees, For Devotees</div>
        </div>
      </div>
    </section>

    <h3 className="section-title">
      <span className="sic" style={{"background":"linear-gradient(135deg,#1F9D55,#0EA5A5)"}}><i className="fa-solid fa-location-crosshairs"></i></span>
      <span>🔴 Live Wari Services — Route, Palki Tracking &amp; SOS</span>
    </h3>
    <div className="live-grid">
      <a className="live-card" href="/route" onClick={goTo('/route')}>
        <div className="ic" style={{"background":"#2563EB"}}><i className="fa-solid fa-map-location-dot"></i></div>
        <span className="live-pill offline">Offline Map</span>
        <h4>Check Route</h4>
        <p>The full walking route with all 15 day-stage halts and where today&rsquo;s stage ends.</p>
        <span className="go">View Route <i className="fa-solid fa-arrow-right"></i></span>
      </a>
      <a className="live-card" href="/palki" onClick={goTo('/palki')}>
        <div className="ic" style={{"background":"#8B1B1B"}}><i className="fa-solid fa-place-of-worship"></i></div>
        <span className="live-pill offline">Works Offline</span>
        <h4>Track Palki Live</h4>
        <p>The Palki&rsquo;s live position and its forecast for the next eight hours — no network needed.</p>
        <span className="go">Track Palki <i className="fa-solid fa-arrow-right"></i></span>
      </a>
      <a className="live-card" href="/help" onClick={goTo('/help')}>
        <div className="ic" style={{"background":"#D64545"}}><i className="fa-solid fa-truck-medical"></i></div>
        <span className="live-pill">SOS</span>
        <h4>Report SOS</h4>
        <p>One tap finds the nearest medical camp; food, water and shelter are ranked by distance too.</p>
        <span className="go">Find Help <i className="fa-solid fa-arrow-right"></i></span>
      </a>
      <a className="live-card" href="/live" onClick={goTo('/live')}>
        <div className="ic" style={{"background":"#E8630C"}}><i className="fa-solid fa-person-walking"></i></div>
        <span className="live-pill">Live GPS</span>
        <h4>My Live Location</h4>
        <p>How far is left, how long it should take, and whether you have drifted off the route.</p>
        <span className="go">Open <i className="fa-solid fa-arrow-right"></i></span>
      </a>
    </div>
    ...
    <div className="quick-actions">
      ...
      <div className="qa-card" data-modal data-feature="live-darshan" tabIndex="0"><div className="ic" style={{"background":"#D64545"}}><i className="fa-solid fa-play"></i></div><span data-i18n="pilgrim.qaLive">Live Darshan Stream</span></div>
    ...
    <h3 className="section-title"><span className="sic" style={{"background":"linear-gradient(135deg,#7C3AED,#5B21B6)"}}><i className="fa-solid fa-grip"></i></span><span data-i18n="pilgrim.exploreServices">Explore Key Services</span></h3>
    <div className="services-grid">

      <div className="svc-card" onClick={goTo('/darshan-booking')} style={{cursor: 'pointer'}}>
        <h3>Darshan Slot Booking</h3>
        <p>Book darshan slots at major temples in advance.</p>
        <div className="svc-thumb" style={{"background":"linear-gradient(135deg,#FCEBD8,#F5C99A)"}}></div>
        <button className="svc-btn" style={{"background":"var(--orange)"}}>Book Now</button>
      </div>

      <div className="svc-card" onClick={goTo('/crowd-status')} style={{cursor: 'pointer'}}>
        <h3>Live Crowd Status</h3>
        <p>Real-time crowd density and safety updates.</p>
        <div className="gauge-wrap">
          <div>
            <b style={{"color":"var(--red)","fontSize":"22px"}}>82%</b>
            <div style={{"fontSize":"11px","color":"var(--text-muted)"}}>High Density</div>
          </div>
          <div style={{"fontSize":"22px","color":"var(--amber)"}}><i className="fa-solid fa-users"></i></div>
        </div>
        <button className="svc-btn" style={{"background":"var(--green)"}}>View Live</button>
      </div>

      <div className="svc-card" onClick={goTo('/route-weather')} style={{cursor: 'pointer'}}>
        <h3>Route & Weather Updates</h3>
        <p>Check yatra routes, distance, facilities & weather.</p>
        <div style={{"display":"flex","justifyContent":"space-between","alignItems":"center"}}>
          <i className="fa-solid fa-location-dot" style={{"color":"var(--red)","fontSize":"22px"}}></i>
          <div style={{"textAlign":"right","fontSize":"12px","fontWeight":"700"}}><i className="fa-solid fa-cloud-sun" style={{"color":"var(--amber)"}}></i> 28°C<br /><span style={{"fontWeight":"500","color":"var(--text-muted)","fontSize":"11px"}}>Partly Cloudy</span></div>
        </div>
        <button className="svc-btn" style={{"background":"#0EA5A5"}}>View Map</button>
      </div>

      <div className="svc-card" onClick={goTo('/group-yatra')} style={{cursor: 'pointer'}}>
        <h3>Create / Join Group Yatra</h3>
        <p>Travel together, stay connected and share location.</p>
        <div className="svc-thumb" style={{"background":"linear-gradient(135deg,#F3E6D8,#C99A6B)"}}></div>
        <button className="svc-btn" style={{"background":"#7C3AED"}}>Get Started</button>
      </div>

      <div className="svc-card" data-modal data-feature="live-darshan" tabIndex="0">
        <h3>Live Darshan Stream</h3>
        <p>Watch darshan live from Pandharpur & other temples.</p>
        <div className="svc-thumb" style={{"background":"linear-gradient(135deg,#3A2416,#7a4a2b)","position":"relative"}}>
          <span className="live-tag">LIVE</span>
        </div>
        <button className="svc-btn" style={{"background":"var(--red)"}}>Watch Now</button>
      </div>

      <div className="svc-card" onClick={goTo('/lost-found')} style={{cursor: 'pointer'}}>
        <h3>Lost & Found Services</h3>
        <p>Report or search for lost items & persons.</p>
        <div className="svc-thumb" style={{"background":"linear-gradient(135deg,#EFE1CC,#C6A87A)"}}></div>
        <button className="svc-btn" style={{"background":"#8B1B1B"}}>Report Now</button>
      </div>

      <div className="svc-card" onClick={goTo('/medical-help')} style={{cursor: 'pointer'}}>
        <h3>Emergency / Medical Help</h3>
        <p>24x7 medical assistance & emergency support.</p>
        <div className="svc-thumb" style={{"background":"linear-gradient(135deg,#FDEAEA,#F5B8B8)","display":"flex","alignItems":"center","justifyContent":"center"}}>
          <i className="fa-solid fa-truck-medical" style={{"fontSize":"34px","color":"var(--red)"}}></i>
        </div>
        <button className="svc-btn" style={{"background":"var(--red)"}}>Call 112</button>
      </div>

      <div className="svc-card" data-modal data-feature="heritage-hub" tabIndex="0">
        <h3>AI Heritage Guide</h3>
        <p>Discover temples, stories, abhang, history & rituals.</p>
        <div className="svc-thumb" style={{"background":"linear-gradient(135deg,#2b2118,#5a4632)","display":"flex","alignItems":"center","justifyContent":"center"}}>
          <i className="fa-solid fa-landmark-dome" style={{"fontSize":"34px","color":"#F5C26B"}}></i>
        </div>
        <button className="svc-btn" style={{"background":"var(--amber)"}}>Explore Now</button>
      </div>

      <div className="svc-card" data-modal data-feature="multilingual" tabIndex="0">
        <h3>Multilingual Access</h3>
        <p>Use VariMitra in your preferred language.</p>
        <div className="lang-chips">
          <span>मराठी</span><span>हिंदी</span><span>English</span><span>தமிழ்</span><span>తెలుగు</span><span>+3</span>
        </div>
        <button className="svc-btn" style={{"background":"var(--blue)"}}>Choose Language</button>
      </div>
    </div>

    
    <div className="alerts-head">
      <h3 className="section-title" style={{"margin":"0"}}><span className="sic" style={{"background":"linear-gradient(135deg,#D64545,#8B1B1B)"}}><i className="fa-solid fa-triangle-exclamation"></i></span><span data-i18n="pilgrim.latestAlerts">Latest Alerts & Notifications</span></h3>
      <a href="#" data-modal data-feature="notifications" tabIndex="0" data-i18n="pilgrim.viewAllAlerts">View All Alerts</a>
    </div>
    <div className="alerts-strip">
      <div className="alert-card" data-modal data-icon="fa-solid fa-fire" data-color="var(--amber)" data-tag="Crowd Alert · Just now" data-title="High Footfall at Main Chowk" data-body="Crowd density has crossed 80% near Main Chowk. Consider the East Entry route or wait 15–20 minutes for the queue to ease." tabIndex="0">
        <div className="ic" style={{"background":"var(--amber)"}}><i className="fa-solid fa-fire"></i></div>
        <div><b>Crowd Alert</b><p>High footfall at Main Chowk</p></div>
      </div>
      <div className="alert-card" data-modal data-icon="fa-solid fa-cloud-rain" data-color="var(--blue)" data-tag="Weather Update · 1 hr ago" data-title="Light Rain Expected" data-body="Light rain is expected in Pandharpur over the next few hours. Carry rain cover and watch for slippery ghats near the river." tabIndex="0">
        <div className="ic" style={{"background":"var(--blue)"}}><i className="fa-solid fa-cloud-rain"></i></div>
        <div><b>Weather Update</b><p>Light rain expected in Pandharpur</p><span className="t">1 hr ago</span></div>
      </div>
      <div className="alert-card" data-modal data-icon="fa-solid fa-road-circle-exclamation" data-color="var(--red)" data-tag="Route Diversion · 2 hrs ago" data-title="Solapur Road Closed" data-body="Solapur Road is closed for the Wari procession. Please use the alternative route via Gopalpur — VariMitra's route guidance will reroute you automatically." tabIndex="0">
        <div className="ic" style={{"background":"var(--red)"}}><i className="fa-solid fa-road-circle-exclamation"></i></div>
        <div><b>Route Diversion</b><p>Solapur Road closed. Use alternative route.</p><span className="t">2 hrs ago</span></div>
      </div>
      <div className="alert-card" data-modal data-icon="fa-solid fa-heart-pulse" data-color="var(--green)" data-tag="Seva Update · 3 hrs ago" data-title="Free Medical Camp" data-body="A free medical camp is now active at Gopalpur Maidan, offering first aid, basic checkups and rest facilities for pilgrims." tabIndex="0">
        <div className="ic" style={{"background":"var(--green)"}}><i className="fa-solid fa-heart-pulse"></i></div>
        <div><b>Seva Update</b><p>Free medical camp at Gopalpur Maidan</p><span className="t">3 hrs ago</span></div>
      </div>
    </div>
  </main>
