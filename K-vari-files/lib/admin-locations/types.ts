...
/** Whether the record is published to the user-facing SOS feature at all. */
...
export interface AdminLocation {
  ...
  /**
   * Distance in km along the pilgrimage route, and metres off it. Derived
   * server-side from latitude/longitude — never sent by the client. This is
   * what the user-side SOS feature sorts "nearest ahead" by; see
   * lib/chainage.ts.
   */
  chainageKm?: number;
  offsetM?: number;
...
/** Fields accepted when creating. Server assigns id//chainage/timestamps. */
